...
function RecordAnswerSection({ mockInterviewQuestion, activeQuestionIndex, interviewData }) {
    ...
    const UpdateUserAnswer = async () => {
        ...
        const feedbackPrompt = "Question: " + mockInterviewQuestion[activeQuestionIndex]?.Question +
            ", User Answer: " + userAnswer + ", Depending on the question and user answer for the given interview question," +
            " please give us rating in numbers from 1 to 5 for answer and feedback as area of improvement if any " +
